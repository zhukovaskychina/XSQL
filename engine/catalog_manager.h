...
public:
    ...
    void set_data_type_length(std::string data_type_length_){this->data_type_length_=data_type_length_;};

    std::string data_type_length(){return this->data_type_length_;};
